...
class LifeStockController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.lifeStocks.index', compact('lifeStocks'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.lifeStocks.create');
    }
    ...
    public function store(StoreLifeStockRequest $request)
    {
        ...
        return redirect()->route('frontend.life-stocks.index');
    }
    ...
    public function edit(LifeStock $lifeStock)
    {
        ...
        return view('frontend.lifeStocks.edit', compact('lifeStock'));
    }
    ...
    public function show(LifeStock $lifeStock)
    {
        ...
        return view('frontend.lifeStocks.show', compact('lifeStock'));
    }
