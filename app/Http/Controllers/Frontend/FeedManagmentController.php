...
class FeedManagmentController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.feedManagments.index', compact('feedManagments'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.feedManagments.create', compact('livestocks'));
    }
    ...
    public function store(StoreFeedManagmentRequest $request)
    {
        ...
        return redirect()->route('frontend.feed-managments.index');
    }
    ...
    public function edit(FeedManagment $feedManagment)
    {
        ...
        return view('frontend.feedManagments.edit', compact('feedManagment', 'livestocks'));
    }
    ...
    public function show(FeedManagment $feedManagment)
    {
        ...
        return view('frontend.feedManagments.show', compact('feedManagment'));
    }
