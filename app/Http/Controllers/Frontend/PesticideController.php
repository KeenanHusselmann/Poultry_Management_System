...
class PesticideController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.pesticides.index', compact('pesticides'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.pesticides.create', compact('life_stocks'));
    }
    ...
    public function store(StorePesticideRequest $request)
    {
        ...
        return redirect()->route('frontend.pesticides.index');
    }
    ...
    public function edit(Pesticide $pesticide)
    {
        ...
        return view('frontend.pesticides.edit', compact('life_stocks', 'pesticide'));
    }
    ...
    public function show(Pesticide $pesticide)
    {
        ...
        return view('frontend.pesticides.show', compact('pesticide'));
    }
