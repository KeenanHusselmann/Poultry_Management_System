...
class FarmController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.farms.index', compact('farms'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.farms.create');
    }
    ...
    public function store(StoreFarmRequest $request)
    {
        ...
        return redirect()->route('frontend.farms.index');
    }
    ...
    public function edit(Farm $farm)
    {
        ...
        return view('frontend.farms.edit', compact('farm'));
    }
    ...
    public function show(Farm $farm)
    {
        ...
        return view('frontend.farms.show', compact('farm'));
    }
