...
class PoultryHouseController extends Controller
{
    public function index()
    {
        ...
        return view('admin.poultryHouses.index', compact('poultryHouses'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.poultryHouses.create', compact('poultry_houses'));
    }
    ...
    public function store(StorePoultryHouseRequest $request)
    {
        ...
        return redirect()->route('admin.poultry-houses.index');
    }
    ...
    public function edit(PoultryHouse $poultryHouse)
    {
        ...
        return view('admin.poultryHouses.edit', compact('poultryHouse', 'poultry_houses'));
    }
    ...
    public function show(PoultryHouse $poultryHouse)
    {
        ...
        return view('admin.poultryHouses.show', compact('poultryHouse'));
    }
