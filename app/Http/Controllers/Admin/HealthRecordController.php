...
class HealthRecordController extends Controller
{
    public function index()
    {
        ...
        return view('admin.healthRecords.index', compact('healthRecords'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.healthRecords.create', compact('diseases', 'live_stocks'));
    }
    ...
    public function edit(HealthRecord $healthRecord)
    {
        ...
        return view('admin.healthRecords.edit', compact('diseases', 'healthRecord', 'live_stocks'));
    }
    ...
    public function show(HealthRecord $healthRecord)
    {
        ...
        return view('admin.healthRecords.show', compact('healthRecord'));
    }
