...
class EggProductionController extends Controller
{
    public function index()
    {
        ...
        return view('admin.eggProductions.index', compact('eggProductions'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.eggProductions.create', compact('eggs'));
    }
    ...
    public function store(StoreEggProductionRequest $request)
    {
        ...
        return redirect()->route('admin.egg-productions.index');
    }
    ...
    public function edit(EggProduction $eggProduction)
    {
        ...
        return view('admin.eggProductions.edit', compact('eggProduction', 'eggs'));
    }
    ...
    public function show(EggProduction $eggProduction)
    {
        ...
        return view('admin.eggProductions.show', compact('eggProduction'));
    }
