    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.health-records.update", [$healthRecord->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="live_stock_id">{{ trans('cruds.healthRecord.fields.live_stock') }}</label>
                            <select class="form-control select2" name="live_stock_id" id="live_stock_id" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="disease_id" id="disease_id">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="record_date" id="record_date" value="{{ old('record_date', $healthRecord->record_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="notes" id="notes">{{ old('notes', $healthRecord->notes) }}</textarea>
                            @if($errors->has('notes'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('notes') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="desc_of_sick" id="desc_of_sick">{{ old('desc_of_sick', $healthRecord->desc_of_sick) }}</textarea>
