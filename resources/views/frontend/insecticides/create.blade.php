        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.create') }} {{ trans('cruds.insecticide.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.insecticides.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="manufacturer" id="manufacturer" value="{{ old('manufacturer', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="usage_instructions" id="usage_instructions">{{ old('usage_instructions') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="safety_instructions" id="safety_instructions">{{ old('safety_instructions') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="expiry_date" id="expiry_date" value="{{ old('expiry_date') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="life_stock_id" id="life_stock_id" required>
                                @foreach($life_stocks as $id => $entry)
                                    <option value="{{ $id }}" {{ old('life_stock_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
