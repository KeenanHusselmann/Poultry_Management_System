    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.life-stocks.update", [$lifeStock->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth', $lifeStock->date_of_birth) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="weight" id="weight" value="{{ old('weight', $lifeStock->weight) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="purchase_date" id="purchase_date" value="{{ old('purchase_date', $lifeStock->purchase_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="notes" id="notes">{{ old('notes', $lifeStock->notes) }}</textarea>
                            @if($errors->has('notes'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('notes') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="number_of_birds" id="number_of_birds" value="{{ old('number_of_birds', $lifeStock->number_of_birds) }}" step="1" required>
