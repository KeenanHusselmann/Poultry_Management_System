    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.poultry-houses.update", [$poultryHouse->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="capacity" id="capacity" value="{{ old('capacity', $poultryHouse->capacity) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="number_of_birds" id="number_of_birds" value="{{ old('number_of_birds', $poultryHouse->number_of_birds) }}" step="1">
