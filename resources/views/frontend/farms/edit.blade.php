    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.farms.update", [$farm->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="farm_name">{{ trans('cruds.farm.fields.farm_name') }}</label>
                            <input class="form-control" type="text" name="farm_name" id="farm_name" value="{{ old('farm_name', $farm->farm_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="farm_location" id="farm_location" value="{{ old('farm_location', $farm->farm_location) }}" required>
