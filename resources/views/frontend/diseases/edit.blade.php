    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.diseases.update", [$disease->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="name">{{ trans('cruds.disease.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $disease->name) }}">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description">{{ old('description', $disease->description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="government_source" id="government_source" value="{{ old('government_source', $disease->government_source) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="other_source" id="other_source" value="{{ old('other_source', $disease->other_source) }}">
