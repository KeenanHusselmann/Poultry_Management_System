    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.diseases.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="government_source" id="government_source" value="{{ old('government_source', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="other_source" id="other_source" value="{{ old('other_source', '') }}">
