    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.feed-managments.update", [$feedManagment->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="name">{{ trans('cruds.feedManagment.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $feedManagment->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="notes" id="notes">{{ old('notes', $feedManagment->notes) }}</textarea>
                            @if($errors->has('notes'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('notes') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="livestock_id" id="livestock_id">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="feeding_date" id="feeding_date" value="{{ old('feeding_date', $feedManagment->feeding_date) }}" required>
