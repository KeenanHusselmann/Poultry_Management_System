<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('farm_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.farms.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/farms") || request()->is("admin/farms/*") ? "c-active" : "" }}">
        ...
        @can('poultry_house_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.poultry-houses.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/poultry-houses") || request()->is("admin/poultry-houses/*") ? "c-active" : "" }}">
        ...
        @can('life_stock_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.life-stocks.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/life-stocks") || request()->is("admin/life-stocks/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
        ...
        @can('feed_managment_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.feed-managments.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/feed-managments") || request()->is("admin/feed-managments/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
        ...
        @endcan
        @can('egg_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/egg-productions*") ? "c-show" : "" }} {{ request()->is("admin/production-reports*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <i class="fa-fw fas fa-crow c-sidebar-nav-icon">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('egg_production_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.egg-productions.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/egg-productions") || request()->is("admin/egg-productions/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
                    ...
                    @endcan
                    @can('production_report_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.production-reports.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/production-reports") || request()->is("admin/production-reports/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-chart-line c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.productionReport.title') }}
                            </a>
                        </li>
                    @endcan
                </ul>
        ...
        @endcan
        @can('chemical_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/create-chemicals*") ? "c-show" : "" }} {{ request()->is("admin/pesticides*") ? "c-show" : "" }} {{ request()->is("admin/insecticides*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('create_chemical_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.create-chemicals.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/create-chemicals") || request()->is("admin/create-chemicals/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
                    ...
                    @can('pesticide_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.pesticides.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/pesticides") || request()->is("admin/pesticides/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
                    ...
                    @can('insecticide_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.insecticides.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/insecticides") || request()->is("admin/insecticides/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
        ...
        @can('disease_information_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/diseases*") ? "c-show" : "" }} {{ request()->is("admin/health-records*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @can('health_record_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.health-records.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/health-records") || request()->is("admin/health-records/*") ? "c-active" : "" }}">
