...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.poultry-houses.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_of_birds') ? 'is-invalid' : '' }}" type="number" name="number_of_birds" id="number_of_birds" value="{{ old('number_of_birds', '') }}" step="1">
