    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.diseases.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('government_source') ? 'is-invalid' : '' }}" type="text" name="government_source" id="government_source" value="{{ old('government_source', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_source') ? 'is-invalid' : '' }}" type="text" name="other_source" id="other_source" value="{{ old('other_source', '') }}">
