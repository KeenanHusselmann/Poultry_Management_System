...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.health-records.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('record_date') ? 'is-invalid' : '' }}" type="text" name="record_date" id="record_date" value="{{ old('record_date') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('desc_of_sick') ? 'is-invalid' : '' }}" name="desc_of_sick" id="desc_of_sick">{{ old('desc_of_sick') }}</textarea>
