...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#customer_incomes" role="tab" data-toggle="tab">
                {{ trans('cruds.income.title') }}
            </a>
        </li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="customer_incomes">
            @includeIf('admin.crmCustomers.relationships.customerIncomes', ['incomes' => $crmCustomer->customerIncomes])
        </div>
    </div>
</div>
