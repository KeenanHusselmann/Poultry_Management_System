...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.pesticides.update", [$pesticide->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.pesticide.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $pesticide->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{{ old('description', $pesticide->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('purchase_date') ? 'is-invalid' : '' }}" type="text" name="purchase_date" id="purchase_date" value="{{ old('purchase_date', $pesticide->purchase_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('quantity') ? 'is-invalid' : '' }}" type="number" name="quantity" id="quantity" value="{{ old('quantity', $pesticide->quantity) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('manufacturer') ? 'is-invalid' : '' }}" type="text" name="manufacturer" id="manufacturer" value="{{ old('manufacturer', $pesticide->manufacturer) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('usage_instructions') ? 'is-invalid' : '' }}" name="usage_instructions" id="usage_instructions">{{ old('usage_instructions', $pesticide->usage_instructions) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('safety_instructions') ? 'is-invalid' : '' }}" name="safety_instructions" id="safety_instructions">{{ old('safety_instructions', $pesticide->safety_instructions) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('expiry_date') ? 'is-invalid' : '' }}" type="text" name="expiry_date" id="expiry_date" value="{{ old('expiry_date', $pesticide->expiry_date) }}" required>
