    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.farms.update", [$farm->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('farm_location') ? 'is-invalid' : '' }}" type="text" name="farm_location" id="farm_location" value="{{ old('farm_location', $farm->farm_location) }}" required>
