...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.feed-managments.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('feeding_date') ? 'is-invalid' : '' }}" type="text" name="feeding_date" id="feeding_date" value="{{ old('feeding_date') }}" required>
