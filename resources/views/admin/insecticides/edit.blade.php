...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.insecticides.update", [$insecticide->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.insecticide.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $insecticide->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{{ old('description', $insecticide->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('purchase_date') ? 'is-invalid' : '' }}" type="text" name="purchase_date" id="purchase_date" value="{{ old('purchase_date', $insecticide->purchase_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('quantity') ? 'is-invalid' : '' }}" type="number" name="quantity" id="quantity" value="{{ old('quantity', $insecticide->quantity) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('manufacturer') ? 'is-invalid' : '' }}" type="text" name="manufacturer" id="manufacturer" value="{{ old('manufacturer', $insecticide->manufacturer) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('usage_instructions') ? 'is-invalid' : '' }}" name="usage_instructions" id="usage_instructions">{{ old('usage_instructions', $insecticide->usage_instructions) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('safety_instructions') ? 'is-invalid' : '' }}" name="safety_instructions" id="safety_instructions">{{ old('safety_instructions', $insecticide->safety_instructions) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('expiry_date') ? 'is-invalid' : '' }}" type="text" name="expiry_date" id="expiry_date" value="{{ old('expiry_date', $insecticide->expiry_date) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('life_stock') ? 'is-invalid' : '' }}" name="life_stock_id" id="life_stock_id" required>
