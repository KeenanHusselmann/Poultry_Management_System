...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.insecticides.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('usage_instructions') ? 'is-invalid' : '' }}" name="usage_instructions" id="usage_instructions">{{ old('usage_instructions') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('safety_instructions') ? 'is-invalid' : '' }}" name="safety_instructions" id="safety_instructions">{{ old('safety_instructions') }}</textarea>
